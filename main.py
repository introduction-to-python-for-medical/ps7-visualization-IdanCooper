...
selected_features = [features[0], features[2], features[8], features[10], features[12]]
...
reference_feature = features[2]  # The reference feature
comparison_feature = features[12]  # A feature to compare to
